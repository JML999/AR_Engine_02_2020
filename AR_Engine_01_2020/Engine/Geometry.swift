...
open class Geometry {
    ...
    var mesh: Mesh!
    var materialCheck = MaterialCheck()
    var _textureType: TextureTypes = TextureTypes.None
    ...
    public func setColor(_ color: SIMD4<Float>){
        self.materialCheck.color = color
        self.materialCheck.useMaterialColor = true
        self.materialCheck.useTexture = false
    }
    
     func setTexture(_ textureType: TextureTypes) {
        self._textureType = textureType
        self.materialCheck.useTexture = true
        self.materialCheck.useMaterialColor = false
    }
    
    public func getColor()->SIMD4<Float>{
        return self.materialCheck.color
    }
