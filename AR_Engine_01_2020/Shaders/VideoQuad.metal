...
//The attribute [[stage_in]] with Vertexin signifies that it is built for us by loading data according to the vertex descriptor
//The second parameter is a reference to matrices we use to transform our vertices
